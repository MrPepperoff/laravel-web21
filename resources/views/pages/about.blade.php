            ...
            <div class="about-content">
                <div class="container container-240">
                    <div class="entry-inside v4 text-center">
                        <img src="../resources/img/single/simple_icon.png" alt="">
                    ...
                    <div class="row pd1">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="about-img">
                                    ...
                                    <img src="../resources/img/about/about_2.jpg" alt="" class="img-responsive">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="about-img">
                                    ...
                                    <img src="../resources/img/about/about_3.jpg" alt="" class="img-responsive">
                        ...
                        <div class="row pd2">
                            <div class="col-xs-12 col-sm-4 col-md-4">
                                <div class="about-element text-center">
                                    <img src="../resources/img/about/icon1.png" alt="">
                            ...
                            <div class="col-xs-12 col-sm-4 col-md-4">
                                <div class="about-element text-center">
                                    <img src="../resources/img/about/icon2.png" alt="">
                                    <h3 class="about-title v2">More than 2000 + items</h3>
                                    <p class="about-desc">Radable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters</p>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-4 col-md-4">
                                <div class="about-element text-center">
                                    <img src="../resources/img/about/icon3.png" alt="">
                                    <h3 class="about-title v2">More than 2000 + items</h3>
                                    <p class="about-desc">Radable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters</p>
                                </div>
                            </div>
                ...
                <div class="container container-240">
                    <div class="team">
                        ...
                        <div class="owl-carousel owl-theme js-owl-team">
                            <div class="team-item">
                                <div class="team-img">
                                    <img src="../resources/img/about/team_1.jpg" alt="">
                                </div>
                                <div class="team-info">
                            ...
                            <div class="team-item">
                                <div class="team-img">
                                    <img src="../resources/img/about/team_2.jpg" alt="">
                                </div>
                                <div class="team-info">
                            ...
                            <div class="team-item">
                                <div class="team-img">
                                    <img src="../resources/img/about/team_3.jpg" alt="">
                                </div>
                                <div class="team-info">
                            ...
                            <div class="team-item">
                                <div class="team-img">
                                    <img src="../resources/img/about/team_4.jpg" alt="">
                                </div>
                                <div class="team-info">
